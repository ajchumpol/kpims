			  ...
			  <table class="w3-table">
			  	<tr>
					...
					<?=form_open("ManageUser/getUser", "autocomplete='off'")?>
			  		...
			  		<td colspan="3" style="padding:0px;margin:0px;"><button onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-blue w3-right">+</button></td>
			  	</tr>
			  </table>
	  ...
	  <div id="id01" class="w3-modal">
		<div class="w3-modal-content">
		  ...
		  <div class="w3-container">
			...
			<td><input class="w3-input w3-border" type="text" id="i_username" name="i_username" onchange="validateUsername()" required></td>
			</tr>
			<tr>
			<td><b>อีเมล<span style="color:#FF0000;">*</span></b></td>
			<td><input class="w3-input w3-border" type="email" id="i_email" name="i_email" onchange="validateEmail()" required></td>
			</tr>
			<tr>
			...
			<td><input class="w3-input w3-border" type="password" id="i_confirm_password" onkeyup="validatePassword()" required></td>
			</tr>
			<tr>
			...
			<button onclick="document.getElementById('id01').style.display='none'" class="w3-button w3-red">ยกเลิก</button>
