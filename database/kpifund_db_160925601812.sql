...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2017 at 01:12 PM
...
--
ALTER TABLE `kpi_cokpi`
  MODIFY `cokpi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `kpi_sub_cokpi`
  MODIFY `subcokpi_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `kpi_sub_issuesdetail`
--
ALTER TABLE `kpi_sub_issuesdetail`
  MODIFY `issdet_id` int(11) NOT NULL AUTO_INCREMENT;
--
